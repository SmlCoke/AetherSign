...
void PerformanceMonitor::AddFrame(uint32_t frame_index, const FrameTiming& timing) {
    ...
    palm_preprocess_resize_ms_.push_back(timing.palm_preprocess_resize_ms);
...
void PerformanceMonitor::PrintReport(uint32_t frame_index) const {
    ...
    const Stats palm_preprocess_resize_stats = CalculateStats(palm_preprocess_resize_ms_);
    ...
    std::cout << "[PERF][palm_detail_ms]"
              ...
              << " palm_preprocess_resize_avg=" << palm_preprocess_resize_stats.avg
              << " palm_preprocess_resize_p95=" << palm_preprocess_resize_stats.p95
...
void PerformanceMonitor::ClearWindow() {
    ...
    palm_preprocess_resize_ms_.clear();
