...
07-02 目前情况：重新训练 Palm Detector 以及 Hand Landmarker，这一次输入尺寸调整为 720x1280，避免旋转（即前面提到的数据预处理）带来的时间开销。目前正在制作数据集、重新训练模型以及尝试上板部署。
...
| 3     | 拇指：第三关节 (thumb_ip)          |
| 4     | 拇指尖 (thumb_tip)             |
| 5     | 食指：第一关节 (index_finger_mcp)  |
| 6     | 食指：第二关节 (index_finger_pip)  |
| 7     | 食指：第三关节 (index_finger_dip)  |
| 8     | 食指尖 (index_tip)             |
| 9     | 中指：第一关节 (middle_finger_mcp) |
| 10    | 中指：第二关节 (middle_finger_pip) |
| 11    | 中指：第三关节 (middle_finger_dip) |
| 12    | 中指尖 (middle_tip)            |
| 13    | 无名指：第一关节 (ring_finger_mcp)  |
| 14    | 无名指：第二关节 (ring_finger_pip)  |
| 15    | 无名指：第三关节 (ring_finger_dip)  |
| 16    | 无名指尖 (ring_tip)             |
| 17    | 小指：第一关节 (pinky_mcp)         |
| 18    | 小指：第二关节 (pinky_pip)         |
| 19    | 小指：第三关节 (pinky_dip)         |
| 20    | 小指尖 (pinky_tip)             |