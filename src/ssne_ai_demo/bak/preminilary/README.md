...
>
> 本 checkpoint 经审核允许公开的模型资产通过 [`aethersign-app-assets-preminilary.zip`](https://github.com/SmlCoke/AetherSign/releases/latest/download/aethersign-app-assets-preminilary.zip) 单独提供；下载与校验说明见 [发布接口文档](../../../../docs/release/README.md)。资产包不包含厂商 SDK 材料。
