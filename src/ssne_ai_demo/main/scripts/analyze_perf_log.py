...
def build_iteration_p95_breakdown_segments(
    ...
    palm_resize = positive_metric_mean(records, "palm_detail_ms", "palm_preprocess_resize_p95")
    palm_tensor_load = (
    ...
    palm_known = zero_if_nan(palm_resize) + palm_tensor_load + zero_if_nan(palm_inference) + palm_post
    ...
    add_positive_segment(segments, "Palm resize", palm_resize)
